#include "BoostedTTH/BoostedAnalyzer/interface/tHqEvent.hpp"
...
void tHqEvent::ak5JetsIdentifyHiggsCand(const float jetMatchingThreshold){
...
void tHqEvent::ak5JetsIdentifyTopHadCand(const float jetMatchingThreshold){
...
void tHqEvent::ak5JetsIdentifyTopLepCand(const float jetMatchingThreshold){
...
void tHqEvent::HiggsCandBoostedRec(HiggsTagger* higgstagger, const float higgsjetptcut, const float higgsjetetacut, const bool cleanTopHadCand, const bool cleanTopLepCand,  const float fatjetCleaningThreshold, const float subjetCleaningThreshold){
...
void tHqEvent::HiggsCandRec(){                                                                    // Non Boosted Higgs Reconstruction by Delta R and Loose Btags
...
void tHqEvent::TopHadCandBoostedRec(TopTagger toptagger,const float topjetptcut, const float topjetetacut){
  topHadCand = boosted::HEPTopJet();
  topHadBCand = pat::Jet();
  topHadW1Cand = pat::Jet();
  topHadW2Cand = pat::Jet();
...
void tHqEvent::BoostedTopHiggsEventRec(TopTagger toptagger, HiggsTagger* higgstagger){
...
void tHqEvent::BoostedHiggsEventRec(HiggsTagger* higgstagger){
...
void tHqEvent::BoostedTopEventRec(TopTagger toptagger){
...
math::XYZTLorentzVector tHqEvent::GetNeutrino1Vec(){
  return nu1VecCand;
}


math::XYZTLorentzVector tHqEvent::GetNeutrino2Vec(){
  return nu2VecCand;
}
...
int tHqEvent::GetNHiggsak5Jets(){
  return nHiggsak5Jets;
}


int tHqEvent::GetNHiggsCandBTagL(){
  return nHiggsCandBTagL;
}


int tHqEvent::GetNHiggsCandBTagM(){
  return nHiggsCandBTagM;
}


int tHqEvent::GetNHiggsCandBTagT(){
  return nHiggsCandBTagT;
}


float tHqEvent::GetAverageCSVHiggsCand(){
...
int tHqEvent::GetNTopHadak5Jets(){
  return nTopHadak5Jets;
}


int tHqEvent::GetNTopHadCandBTagL(){
  return nTopHadCandBTagL;
}


int tHqEvent::GetNTopHadCandBTagM(){
  return nTopHadCandBTagM;
}


int tHqEvent::GetNTopHadCandBTagT(){
  return nTopHadCandBTagT;
}


float tHqEvent::GetAverageCSVTopHadCand(){
...
int tHqEvent::GetNTopLepak5Jets(){
  return nTopLepak5Jets;
}


int tHqEvent::GetNTopLepCandBTagL(){
  return nTopLepCandBTagL;
}


int tHqEvent::GetNTopLepCandBTagM(){
  return nTopLepCandBTagM;
}


int tHqEvent::GetNTopLepCandBTagT(){
  return nTopLepCandBTagT;
}


float tHqEvent::GetAverageCSVTopLepCand(){
...
boosted::SubFilterJet tHqEvent::GetHiggsCandBoosted(){
...
pat::Jet tHqEvent::GetHiggsB1Cand(){
...
pat::Jet tHqEvent::GetHiggsB2Cand(){
  if(!foundHiggsCand) return pat::Jet();
...
pat::Jet tHqEvent::GetHiggsGCand(){
  if(!foundHiggsCand) return pat::Jet();
...
math::XYZTLorentzVector tHqEvent::GetHiggsCandVec3(){
...
math::XYZTLorentzVector tHqEvent::GetHiggsCandVec2(){
  if(!foundHiggsCand) return math::XYZTLorentzVector();
...
boosted::HEPTopJet tHqEvent::GetTopHadCandBoosted(){
...
pat::Jet tHqEvent::GetTopHadBCand(){
...
pat::Jet tHqEvent::GetTopHadW1Cand(){
  if(!foundTopHadCand) return pat::Jet();
...
pat::Jet tHqEvent::GetTopHadW2Cand(){
  if(!foundTopHadCand) return pat::Jet();
...
math::XYZTLorentzVector tHqEvent::GetTopHadCandVec(){
...
math::XYZTLorentzVector tHqEvent::GetWHadCandVec(){
  if(!foundTopHadCand) return math::XYZTLorentzVector();
...
pat::Jet tHqEvent::GetTopLepBCand(){
...
math::XYZTLorentzVector tHqEvent::GetTopLepCandVec(){
...
math::XYZTLorentzVector tHqEvent::GetWLepCandVec(){
...
bool tHqEvent::GetFoundTopHad(){
  if(foundTopHadCand) return true; 
  else return false;
  
}

float tHqEvent::GetHiggsTag(){
